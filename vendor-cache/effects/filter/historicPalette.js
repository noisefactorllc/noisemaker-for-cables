...
var n=class{constructor(e={}){this.state={},this.uniforms={},e.name&&(this.name=e.name),e.namespace&&(this.namespace=e.namespace),e.func&&(this.func=e.func),e.description&&(this.description=e.description),e.tags&&(this.tags=e.tags),e.globals&&(this.globals=e.globals),e.passes&&(this.passes=e.passes),e.textures&&(this.textures=e.textures),e.outputTex3d&&(this.outputTex3d=e.outputTex3d),e.outputGeo&&(this.outputGeo=e.outputGeo),e.uniformLayout&&(this.uniformLayout=e.uniformLayout),e.uniformLayouts&&(this.uniformLayouts=e.uniformLayouts),e.paramAliases&&(this.paramAliases=e.paramAliases),e.openCategories&&(this.openCategories=e.openCategories),e.defaultProgram&&(this.defaultProgram=e.defaultProgram),e.hidden&&(this.hidden=!0),e.deprecatedBy&&(this.deprecatedBy=e.deprecatedBy),e.onInit&&(this._configOnInit=e.onInit),e.onUpdate&&(this._configOnUpdate=e.onUpdate),e.onDestroy&&(this._configOnDestroy=e.onDestroy),e.asyncInit&&(this._configAsyncInit=e.asyncInit)}onInit(){this._configOnInit&&this._configOnInit.call(this)}onUpdate(e){return this._configOnUpdate?this._configOnUpdate.call(this,e):{}}onDestroy(){this._configOnDestroy&&this._configOnDestroy.call(this)}asyncInit(e){return this._configAsyncInit?this._configAsyncInit.call(this,e):Promise.resolve()}};var t=new n({name:"Historic Palette",namespace:"filter",func:"historicPalette",tags:["color","palette"],description:"Apply historical art color palettes",globals:{index:{type:"int",default:4,uniform:"paletteIndex",choices:{aboriginalDot:0,abstractExpressionism:1,artDeco:2,artNouveau:3,bauhaus:4,caveArt:5,chineseInk:6,dutchGoldenAge:7,fauvism:8,impressionism:9,indianMiniature:10,islamicGeometric:11,kenteCloth:12,maoriCarving:13,mexicanMuralism:14,minimalism:15,persianMiniature:16,popArt:17,renaissance:18,surrealism:19,ukiyoe:20},ui:{label:"palette",control:"dropdown"}},rotation:{type:"float",default:0,uniform:"rotation",choices:{none:0,fwd:1,back:-1},ui:{label:"rotation",control:"dropdown"}},offset:{type:"float",default:0,uniform:"offset",min:0,max:100,step:1,ui:{label:"offset",control:"slider"}},repeat:{type:"int",default:1,uniform:"repeat",min:1,max:10,randMax:5,ui:{label:"repeat",control:"slider"}},alpha:{type:"float",default:1,uniform:"alpha",min:0,max:1,randMin:.5,step:.01,ui:{label:"alpha",control:"slider"}},smoothness:{type:"float",default:0,uniform:"smoothness",min:0,max:1,ui:{label:"smoothness",control:"slider"}}},defaultProgram:`search filter, synth

noise(ridges: true, colorMode: mono)
.historicPalette()
.write(o0)`,paramAliases:{paletteIndex:"index"},passes:[{name:"render",program:"historicPalette",inputs:{inputTex:"inputTex"},outputs:{fragColor:"outputTex"}}]});var o={historicPalette:{glsl:`/*
...
render(o0)
\`\`\`
`;if(t&&Object.keys(o).length>0){t.shaders||(t.shaders={});for(let[a,e]of Object.entries(o))t.shaders[a]={...e}}t&&r&&(t.help=r);var d="filter/historicPalette",u="filter",h="historicPalette",m=t;export{m as default,d as effectId,h as effectName,r as help,u as namespace};
