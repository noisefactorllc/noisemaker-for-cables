...
render(o0)
\`\`\`
`;if(n&&Object.keys(r).length>0){n.shaders||(n.shaders={});for(let[i,e]of Object.entries(r))n.shaders[i]={...e}}n&&a&&(n.help=a);var h="filter/chrome",c="filter",m="chrome",p=n;export{p as default,h as effectId,m as effectName,a as help,c as namespace};
