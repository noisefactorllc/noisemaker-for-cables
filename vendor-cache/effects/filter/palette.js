...
Apply cosine color palettes based on luminance
...
render(o0)
\`\`\`
`;if(n&&Object.keys(a).length>0){n.shaders||(n.shaders={});for(let[r,e]of Object.entries(a))n.shaders[r]={...e}}n&&c&&(n.help=c);var s="filter/palette",i="filter",p="palette",b=n;export{b as default,s as effectId,p as effectName,c as help,i as namespace};
