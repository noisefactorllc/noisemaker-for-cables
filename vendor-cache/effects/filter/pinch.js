...
Pinch distortion toward center
...
render(o0)
\`\`\`
`;if(n&&Object.keys(i).length>0){n.shaders||(n.shaders={});for(let[o,t]of Object.entries(i))n.shaders[o]={...t}}n&&a&&(n.help=a);var p="filter/pinch",f="filter",c="pinch",d=n;export{d as default,p as effectId,c as effectName,a as help,f as namespace};
