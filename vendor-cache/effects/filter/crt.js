/* filter/crt */
var a=class{constructor(e={}){this.state={},this.uniforms={},e.name&&(this.name=e.name),e.namespace&&(this.namespace=e.namespace),e.func&&(this.func=e.func),e.description&&(this.description=e.description),e.tags&&(this.tags=e.tags),e.globals&&(this.globals=e.globals),e.passes&&(this.passes=e.passes),e.textures&&(this.textures=e.textures),e.outputTex3d&&(this.outputTex3d=e.outputTex3d),e.outputGeo&&(this.outputGeo=e.outputGeo),e.uniformLayout&&(this.uniformLayout=e.uniformLayout),e.uniformLayouts&&(this.uniformLayouts=e.uniformLayouts),e.paramAliases&&(this.paramAliases=e.paramAliases),e.openCategories&&(this.openCategories=e.openCategories),e.defaultProgram&&(this.defaultProgram=e.defaultProgram),e.hidden&&(this.hidden=!0),e.deprecatedBy&&(this.deprecatedBy=e.deprecatedBy),e.onInit&&(this._configOnInit=e.onInit),e.onUpdate&&(this._configOnUpdate=e.onUpdate),e.onDestroy&&(this._configOnDestroy=e.onDestroy),e.asyncInit&&(this._configAsyncInit=e.asyncInit)}onInit(){this._configOnInit&&this._configOnInit.call(this)}onUpdate(e){return this._configOnUpdate?this._configOnUpdate.call(this,e):{}}onDestroy(){this._configOnDestroy&&this._configOnDestroy.call(this)}asyncInit(e){return this._configAsyncInit?this._configAsyncInit.call(this,e):Promise.resolve()}};var n=new a({name:"CRT",namespace:"filter",func:"crt",tags:["distort"],description:"CRT monitor simulation",globals:{alpha:{type:"float",default:.5,uniform:"alpha",min:0,max:1,step:.01,zero:0,ui:{label:"alpha",control:"slider"}},speed:{type:"float",default:1,uniform:"speed",min:0,max:5,step:.1,ui:{label:"speed",control:"slider"}},seed:{type:"int",default:1,min:1,max:100,step:1,uniform:"seed",ui:{label:"seed",control:"slider"}}},passes:[{name:"main",program:"crt",inputs:{inputTex:"inputTex"},uniforms:{alpha:"alpha",speed:"speed",seed:"seed"},outputs:{fragColor:"outputTex"}}]});var l={crt:{glsl:`#version 300 es
...
}`,wgsl:`// CRT effect - faithful port of Python implementation
// Applies scanlines, lens warp, chromatic aberration, hue shift, saturation boost, and vignette
...
render(o0)
\`\`\`
`;if(n&&Object.keys(l).length>0){n.shaders||(n.shaders={});for(let[t,e]of Object.entries(l))n.shaders[t]={...e}}n&&s&&(n.help=s);var c="filter/crt",_="filter",d="crt",p=n;export{p as default,c as effectId,d as effectName,s as help,_ as namespace};
