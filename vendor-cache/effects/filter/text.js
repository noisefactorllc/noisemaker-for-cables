...
render(o0)
\`\`\`
`;if(n&&Object.keys(i).length>0){n.shaders||(n.shaders={});for(let[a,e]of Object.entries(i))n.shaders[a]={...e}}n&&s&&(n.help=s);var h="filter/text",y="filter",g="text",b=n;export{b as default,h as effectId,g as effectName,s as help,y as namespace};
