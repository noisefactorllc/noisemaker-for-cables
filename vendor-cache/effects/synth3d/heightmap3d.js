...
`}},a=null;if(t&&Object.keys(o).length>0){t.shaders||(t.shaders={});for(let[i,e]of Object.entries(o))t.shaders[i]={...e}}t&&a&&(t.help=a);var c="synth3d/heightmap3d",p="synth3d",h="heightmap3d",m=t;export{m as default,c as effectId,h as effectName,a as help,p as namespace};
