...
var t=class{constructor(e={}){this.state={},this.uniforms={},e.name&&(this.name=e.name),e.namespace&&(this.namespace=e.namespace),e.func&&(this.func=e.func),e.description&&(this.description=e.description),e.tags&&(this.tags=e.tags),e.globals&&(this.globals=e.globals),e.passes&&(this.passes=e.passes),e.textures&&(this.textures=e.textures),e.outputTex3d&&(this.outputTex3d=e.outputTex3d),e.outputGeo&&(this.outputGeo=e.outputGeo),e.uniformLayout&&(this.uniformLayout=e.uniformLayout),e.uniformLayouts&&(this.uniformLayouts=e.uniformLayouts),e.paramAliases&&(this.paramAliases=e.paramAliases),e.openCategories&&(this.openCategories=e.openCategories),e.defaultProgram&&(this.defaultProgram=e.defaultProgram),e.hidden&&(this.hidden=!0),e.deprecatedBy&&(this.deprecatedBy=e.deprecatedBy),e.onInit&&(this._configOnInit=e.onInit),e.onUpdate&&(this._configOnUpdate=e.onUpdate),e.onDestroy&&(this._configOnDestroy=e.onDestroy),e.asyncInit&&(this._configAsyncInit=e.asyncInit)}onInit(){this._configOnInit&&this._configOnInit.call(this)}onUpdate(e){return this._configOnUpdate?this._configOnUpdate.call(this,e):{}}onDestroy(){this._configOnDestroy&&this._configOnDestroy.call(this)}asyncInit(e){return this._configAsyncInit?this._configAsyncInit.call(this,e):Promise.resolve()}};var n=new t({name:"Glitch",namespace:"classicNoisedeck",func:"glitch",tags:["distort","glitch"],description:"Digital glitch effects",globals:{glitchiness:{type:"float",default:0,uniform:"glitchiness",min:0,max:100,ui:{label:"glitchiness",control:"slider"}},aberration:{type:"float",default:0,uniform:"aberration",min:0,max:100,ui:{label:"aberration",control:"slider"}},xChonk:{type:"int",default:1,uniform:"xChonk",min:1,max:100,ui:{label:"width",control:"slider"}},yChonk:{type:"int",default:1,uniform:"yChonk",min:1,max:100,ui:{label:"height",control:"slider"}},seed:{type:"int",default:1,uniform:"seed",min:1,max:100,ui:{label:"seed",control:"slider"}},scanlinesAmt:{type:"int",default:0,uniform:"scanlinesAmt",min:0,max:100,ui:{label:"scanlines",control:"slider",category:"effects"}},snowAmt:{type:"float",default:0,uniform:"snowAmt",min:0,max:100,ui:{label:"snow",control:"slider",category:"effects"}},vignetteAmt:{type:"float",default:0,uniform:"vignetteAmt",min:-100,max:100,ui:{label:"vignette",control:"slider",category:"effects"}},distortion:{type:"float",default:0,uniform:"distortion",min:-100,max:100,ui:{label:"lens",control:"slider",category:"distortion"}},aspectLens:{type:"boolean",default:!1,uniform:"aspectLens",ui:{label:"1:1 aspect",control:"checkbox",category:"distortion"}}},paramAliases:{aberrationAmt:"aberration"},passes:[{name:"render",program:"glitch",inputs:{inputTex:"inputTex"},outputs:{fragColor:"outputTex"}}]});var s={glitch:{glsl:`#version 300 es
...
render(o0)
\`\`\`
`;if(n&&Object.keys(s).length>0){n.shaders||(n.shaders={});for(let[o,e]of Object.entries(s))n.shaders[o]={...e}}n&&f&&(n.help=f);var l="classicNoisedeck/glitch",u="classicNoisedeck",v="glitch",m=n;export{m as default,l as effectId,v as effectName,f as help,u as namespace};
