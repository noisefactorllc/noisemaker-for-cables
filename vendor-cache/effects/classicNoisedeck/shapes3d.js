...
render(o1)
\`\`\`
`;if(t&&Object.keys(c).length>0){t.shaders||(t.shaders={});for(let[n,e]of Object.entries(c))t.shaders[n]={...e}}t&&m&&(t.help=m);var O="classicNoisedeck/shapes3d",T="classicNoisedeck",H="shapes3d",N=t;export{N as default,O as effectId,H as effectName,m as help,T as namespace};
