...
`,wgsl:`// Hflow agent pass - Common Agent Architecture middleware
...
render(o0)
\`\`\`
`;if(e&&Object.keys(r).length>0){e.shaders||(e.shaders={});for(let[i,n]of Object.entries(r))e.shaders[i]={...n}}e&&o&&(e.help=o);var f="points/hydraulic",d="points",p="hydraulic",c=e;export{c as default,f as effectId,p as effectName,o as help,d as namespace};
