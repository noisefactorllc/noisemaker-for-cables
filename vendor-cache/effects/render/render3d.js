/* render/render3d */
var t=class{constructor(e={}){this.state={},this.uniforms={},e.name&&(this.name=e.name),e.namespace&&(this.namespace=e.namespace),e.func&&(this.func=e.func),e.description&&(this.description=e.description),e.tags&&(this.tags=e.tags),e.globals&&(this.globals=e.globals),e.passes&&(this.passes=e.passes),e.textures&&(this.textures=e.textures),e.outputTex3d&&(this.outputTex3d=e.outputTex3d),e.outputGeo&&(this.outputGeo=e.outputGeo),e.uniformLayout&&(this.uniformLayout=e.uniformLayout),e.uniformLayouts&&(this.uniformLayouts=e.uniformLayouts),e.paramAliases&&(this.paramAliases=e.paramAliases),e.openCategories&&(this.openCategories=e.openCategories),e.defaultProgram&&(this.defaultProgram=e.defaultProgram),e.hidden&&(this.hidden=!0),e.deprecatedBy&&(this.deprecatedBy=e.deprecatedBy),e.onInit&&(this._configOnInit=e.onInit),e.onUpdate&&(this._configOnUpdate=e.onUpdate),e.onDestroy&&(this._configOnDestroy=e.onDestroy),e.asyncInit&&(this._configAsyncInit=e.asyncInit)}onInit(){this._configOnInit&&this._configOnInit.call(this)}onUpdate(e){return this._configOnUpdate?this._configOnUpdate.call(this,e):{}}onDestroy(){this._configOnDestroy&&this._configOnDestroy.call(this)}asyncInit(e){return this._configAsyncInit?this._configAsyncInit.call(this,e):Promise.resolve()}};var n=new t({name:"Render3D",namespace:"render",tags:["3d"],func:"render3d",description:"Universal 3D volume raymarcher",textures:{screenGeoBuffer:{width:"resolution",height:"resolution",format:"rgba16f"}},globals:{volumeSize:{type:"int",default:64,uniform:"volumeSize",choices:{v16:16,v32:32,v64:64,v128:128},ui:{control:!1}},filtering:{type:"int",default:0,define:"FILTERING",choices:{isosurface:0,voxel:1},ui:{label:"filtering",control:"dropdown"}},threshold:{type:"float",default:.5,min:0,max:1,randMax:.3,uniform:"threshold",ui:{label:"threshold"}},invert:{type:"boolean",default:!1,randChance:0,define:"INVERT",ui:{label:"invert thresh"}},orbitSpeed:{type:"int",default:1,min:-5,max:5,randMin:-1,randMax:1,uniform:"orbitSpeed",ui:{label:"orbit speed"}},bgColor:{type:"color",default:[.02,.02,.02],uniform:"bgColor",ui:{label:"bg color",control:"color"}},bgAlpha:{type:"float",default:1,min:0,max:1,uniform:"bgAlpha",ui:{label:"bg opacity"}}},passes:[{name:"render",program:"render3d",drawBuffers:2,inputs:{volumeCache:"inputTex3d",analyticalGeo:"inputGeo"},outputs:{color:"outputTex",geoOut:"screenGeoBuffer"}}],outputGeo:"screenGeoBuffer",outputTex3d:"inputTex3d"});var l={render3d:{glsl:`/*
...
render(o0)
\`\`\`
`;if(n&&Object.keys(l).length>0){n.shaders||(n.shaders={});for(let[o,e]of Object.entries(l))n.shaders[o]={...e}}n&&i&&(n.help=i);var v="render/render3d",f="render",d="render3d",u=n;export{u as default,v as effectId,d as effectName,i as help,f as namespace};
